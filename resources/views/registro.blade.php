...
<body>
    ...
    <div class="container">
        <h2>
            ...
            <a href="#" class="return-link">REGRESAR</a>
        </h2>

        <p>Favor de llenar los siguientes datos. Los campos marcados con asterisco (*) son obligatorios.</p>

        {{-- Apertura del formulario Laravel: @yield('content') si usas un layout --}}
        <form method="POST" action="{{-- route('your.registration.route') --}}">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <div class="radio-group">
                        <input type="radio" id="pais_mexico" name="pais" value="México" checked {{-- old('pais', 'México') == 'México' ? 'checked' : '' --}}>
