...
<head>
    ...
    <title>Gestión de Expedientes - Tribunal Electrónico - Poder Judicial Tamaulipas</title>
    ...
    <style>
        ...
        /* Estilos específicos del formulario de Expediente */
        ...
        .info-display-static { /* Estilo para campos no editables si se usa */
            ...
            <div class="row">
                ...
                <div class="col-md-3 bg-light py-4 border-end">
                    <div class="list-group rounded-md">
                        ...
                        <a href="{{ route('expedientes.create') }}" class="list-group-item list-group-item-action active" aria-current="true">
